...
cat > src/components/ui/alert-dialog.tsx << 'EOL'
...
# Create DeleteTableDialog
cat > src/components/tables/DeleteTableDialog.tsx << 'EOL'
...
# Update index.ts
cat > src/components/tables/index.ts << 'EOL'
...
echo "Created DeleteTableDialog component and updated dependencies"
echo "Don't forget to update DataTableWithState.tsx with the provided code"